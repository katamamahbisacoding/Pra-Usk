              ...
              <tbody>
                ...
                ?>
                    <tr>
                      ...
                      <td>
                        <a href="update.php?id=<?= $data['id_siswa']; ?>" class="btn btn-warning btn-sm">Edit</a>
                        <a href="delete_siswa.php?id=<?= $data['id_siswa']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Hapus data ini?');">Hapus</a>
                      </td>
                    </tr>
                <?php
                  endwhile;
